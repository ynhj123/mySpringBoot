...
import com.test.util.constant.HttpRequestHeaderConstant;
...
public class HttpServletRequestUtils {
     ...
     * @Description: 
     * @author: wwb
     * @Date: 2018-08-23 09:30:08
     * @param: request
     * @return: boolean
     */
    public static boolean isCustomAjax(HttpServletRequest request) {
        String requestType = request.getHeader("X-Requested-With");
        String customRequestType = request.getHeader("X-Requested-Custom-Type");
        return "XMLHttpRequest".equals(requestType) && "ajax".equals(customRequestType);
    }
}
