...
public class HttpClientUtils {
    ...
    private static OkHttpClient getOkHttpClient(boolean proxy) {
        ProfilesProperties profilesProperties = SpringContextHolder.getBean("profilesProperties");
        if ("dev".equals(profilesProperties.getActive()) && proxy) {
    ...
    private static Proxy getProxy() {
        return new Proxy(Proxy.Type.SOCKS, new InetSocketAddress("127.0.0.1", 1090));
    }
